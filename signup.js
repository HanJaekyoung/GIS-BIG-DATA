...
function changePhone3(){
    ...
    if(phone3.length === 4){
      ...
      document.getElementById("sendMessage").setAttribute("style","background-color:powderblue;")
...
function initButton(){
  ...
  document.getElementById("sendMessage").setAttribute("style","background-color:powderblue;")
  document.getElementById("completion").setAttribute("style","background-color:green;")
}
